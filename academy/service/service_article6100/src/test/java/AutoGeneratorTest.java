...
public class AutoGeneratorTest {
    ...
    public void test(){
        ...
        gc.setOutputDir("F:\\program files\\idea-workspace\\guli\\service\\service_article6100" + "/src/main/java");// 绝对路径设置代码生成的位置
        ...
        pc.setModuleName("articleService");// 指定模块名
        ...
        strategy.setInclude("cms_article","cms_article_sort","cms_article_comment");//指定数据库表名
