...
public class AutoGeneratorTest {
    ...
    public void test(){
        ...
        gc.setOutputDir("F:\\program files\\idea-workspace\\guli\\service\\service_cms6001" + "/src/main/java");// 绝对路径设置代码生成的位置
        ...
        pc.setModuleName("cmsService");// 指定模块名
